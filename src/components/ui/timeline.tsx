...
export const Timeline = ({ data }: { data: TimelineEntry[] }) => {
  ...
  return (
    <div className="w-full bg-custom-bg bg-cover  font-sans md:px-10" ref={containerRef}>
        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              ...
              <h2 className="hidden md:block  text-xl pl-10 md:pl-20 md:text-3xl md:max-w-xl font-bold text-white">
                {item.title}
              </h2>
            </div>
