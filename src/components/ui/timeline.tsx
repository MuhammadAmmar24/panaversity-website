        ...
        {data.map((item, index) => (
          ...
          >
            <div className="sticky flex flex-col md:flex-row z-40 items-center top-40 self-start max-w-xs lg:max-w-sm md:w-full">
              <div className="h-7 md:h-10 absolute left-2 md:left-3 w-7 md:w-10 rounded-full bg-white dark:bg-black flex justify-center items-center ">
                <div className="md:h-4 md:w-4 h-2 w-2 rounded-full bg-primary dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 p-2" />
              </div>
              <h3 className="hidden md:block text-xl pl-10 md:pl-20 md:text-3xl font-bold text-white">
                {item.title}
              </h3>
            </div>
