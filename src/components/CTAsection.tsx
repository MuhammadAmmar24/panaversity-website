...
export default function Component() {
  return (
    <div className="flex justify-center items-center h-[35em] sm:h-[25em] md:h-[40em] px-6 sm:px-[4rem] md:px[5rem] mt-2 bg-background">
      <div className="bg-custom-bg1 flex flex-col justify-center items-center gap-1 bg-center bg-cover rounded-3xl p-5 md:p-[3rem] lg:p-[5rem] max-w-3xl md:max-w-[72em] text-center border-2">
        ...
        <a
          href="#_"
          className="relative flex items-center justify-center px-14 py-4 overflow-hidden text-[1rem] text-textPrimary font-inter bg-background rounded-[40px] hover:text-textPrimary font-semibold group hover:bg-accent"
        >
