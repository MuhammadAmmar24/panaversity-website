...
import nueral from "../../public/cta/nueral2.jpg"
    ...
    <div>
      ...
      >
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          ...
          <a
            href="#"
            className="mt-8 w-full inline-flex items-center justify-center px-5 font-semibold py-3 border border-transparent text-white font-medium rounded-md  bg-indigo-700 hover:bg-black
