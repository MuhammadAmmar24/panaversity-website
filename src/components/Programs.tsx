...
const Programs = () => {
  return (
    <section className="lg:max-w-[930px] xl:max-w-[1120px] mx-auto px-4 sm:px-6 lg:px-[0rem] py-8 sm:py-12 lg:py-16">
      ...
      <div className='mt-8  sm:mt-8  md:mt-10'>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6 justify-items-center '>
          {programsData.map((program, index) => (
            <div
              key={program.id}
              className={`w-full  bg-background border border-gray-200 hover:shadow-accent shadow-sm rounded-2xl p-6 transform transition duration-400 hover:shadow-md
