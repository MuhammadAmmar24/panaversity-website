...
const Programs = () => {
  return (
    <div className='w-full bg-background  xl:px-24 py-[5rem] flex flex-col items-center justify-center'>
      ...
      <h1 className='text-3xl text-textPrimary font-poppins font-semibold tracking-tighter text-center sm:text-4xl md:text-5xl'>Active Programs</h1>
      ...
      {/* Cards */}
      <div className='pt-12 sm:pt-16 px-5 xs:px-12 sm:px-5 md:px-20 grid grid-cols-1 sm:grid-cols-2  xl:grid-cols-3 gap-12 justify-center'>
        {programsData.map((program) => (
          <div
            key={program.id}
            className='w-full bg-background border-2 border-gray-200 hover:border-accent shadow-sm rounded-2xl p-6 transform transition duration-400 hover:shadow-md'
          >
