      ...
      <div className="relative isolate px-6  lg:px-8 ">
        ...
        <div className="mx-auto max-w-5xl pt-[5rem] sm:pt-[6rem] md:pt-[7rem] lg:pt-[8  rem] " >
          ...
          <div className="text-center">
            ...
            <a href="#_" className="relative inline-flex items-center px-12 py-4 overflow-hidden text-lg  text-textPrimary font-inter bg-accent  rounded-[40px] hover:text-textPrimary font-semibold group hover:bg-background border-2 border-accent ">
