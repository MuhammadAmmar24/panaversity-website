  ...
  return (
    <Dialog.Root open={open} onOpenChange={(isOpen) => isOpen ? setOpen(true) : router.back()}>
      <Dialog.Portal>
        ...
        <Dialog.Content className="z-50 fixed top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 bg-background rounded-lg p-4 w-[300px] mobileM:w-[350px] xs:w-[400px] md:w-[400px] max-h-[85vh] overflow-y-auto">
