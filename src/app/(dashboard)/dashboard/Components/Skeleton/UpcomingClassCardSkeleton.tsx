      ...
      <div className="bg-white rounded-lg shadow-xl flex flex-col justify-between gap-2 px-4 fold:px-2 mobileM:px-4 sm:px-6 md:px-8 py-5">
        ...
        <div className="flex flex-col flex-wrap">
          <div className="flex gap-x-2 flex-wrap">
            ...
            <div className="h-6 fold:h-5 mobileM:h-6 w-48 bg-gray-200 rounded-full"></div>
          </div>
        ...
        <div className="flex flex-col gap-2">
          ...
          <div className="flex items-center gap-3">
            <div className="h-14 fold:h-14 mobileM:h-16 w-16 fold:w-14 mobileM:w-14 bg-gray-200 rounded-full"></div>
            <div className="h-6 fold:h-5 mobileM:h-6 w-36 bg-gray-200 rounded-full"></div>
            <div className="h-5 fold:h-4 mobileM:h-5 w-5 bg-gray-200 rounded-full"></div>
          </div>
        </div>
