...
export default function ServerError() {
  return (
    <>
      <main className="flex flex-col justify-center items-center bg-background px-5">
        ...
        <p className="px-3 font-inter text-center text-lg text-textSecondary">
          Please refresh the page. If error presists, contact support.
        </p>
        <Link
          href="/"
