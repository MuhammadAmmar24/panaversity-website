...
import { FaCheckSquare, FaSquare, FaExclamationCircle } from "react-icons/fa"; // Example icons
...
const InfoCard: React.FC<InfoCardProps> = ({ title, count, icon }) => {
  return (
    <div className="bg-white rounded-lg shadow-md p-6 flex justify-between items-center w-full h-32 mr-5 ml-5">
      <div>
